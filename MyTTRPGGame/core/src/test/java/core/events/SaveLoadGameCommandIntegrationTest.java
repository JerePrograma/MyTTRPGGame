...
import com.jereprograma.myttrpg.core.commands.game.LoadGameCommand;
...
class SaveLoadGameCommandIntegrationTest {
    ...
    void testSaveCommandFiresSaveResultEvent() {
        ...
        EventBus.fire(new SaveGameCommand(testName));
    ...
    void testLoadCommandFiresLoadResultEvent() throws Exception {
        ...
        EventBus.fire(new LoadGameCommand(testName));
